...
yay -S sddm firefox thunar gvfs alacritty neovim pipewire wireplumber pipewire-pulse pavucontrol xdg-desktop-portal-hyprland-git stow neofetch zsh tmux rofi-lbonn-wayland-git sddm-sugar-dark hyprpaper-git python-pywal zenity waybar rose-pine-hyprcursor wl-clipboard xclip mirage
