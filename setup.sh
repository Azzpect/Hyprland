...
yay -S sddm firefox yazi gvfs kitty neovim pipewire wireplumber pipewire-pulse pavucontrol xdg-desktop-portal-hyprland-git stow neofetch zsh tmux rofi hyprpaper python-pywal zenity waybar rose-pine-hyprcursor wl-clipboard xclip mirage grim slurp nodejs npm
